...
import com.ai.chat.infrastructure.LocalizedRagPromptBuilder;
...
class VisionChatUseCaseTest {
    ...
    @BeforeEach
    void setUp() {
        visionChatUseCase = new VisionChatUseCase(
    ...
    void should_emitTokenStreamAndSources_when_imagesProvided() {
        ...
        StepVerifier.create(visionChatUseCase.chatStreamWithImages(
    ...
    void should_emitErrorEvent_when_streamFails() {
        ...
        StepVerifier.create(visionChatUseCase.chatStreamWithImages(
                        "question", null, List.of("iVBORw0KGgo="), null))
                .assertNext(event -> {
