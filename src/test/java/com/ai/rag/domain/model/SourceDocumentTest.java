 ...
 *
 * <p>Tests for SourceDocument immutable record following TDD principles: - Naming convention:
 * should_expected_result_when_condition - Uses AAA pattern (Arrange-Act-Assert) - Tests record
