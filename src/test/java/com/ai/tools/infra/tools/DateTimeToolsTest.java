...
class DateTimeToolsTest {
  ...
  void shouldReturnZonedDatetimeInUserTimezoneWhenCalled() {
    ...
    LocaleContextHolder.setLocaleContext(
        new SimpleTimeZoneAwareLocaleContext(Locale.CHINA, TimeZone.getTimeZone(shanghai)));
  ...
  void shouldUseLocaleContextTimezoneWhenUtc() {
    Instant fixed = Instant.parse("2026-07-26T04:40:00Z");
    LocaleContextHolder.setLocaleContext(
        new SimpleTimeZoneAwareLocaleContext(Locale.US, TimeZone.getTimeZone("UTC")));
