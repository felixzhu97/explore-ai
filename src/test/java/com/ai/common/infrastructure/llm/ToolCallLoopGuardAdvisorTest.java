...
class ToolCallLoopGuardAdvisorTest {
    ...
    private static final ToolCallLoopGuardAdvisor ADVISOR = ToolCallLoopGuardAdvisor.builder().build();
    ...
    class StageRemindersViaManager {
        ...
        void shouldAppendFinalReminderWhenTerminalToolExecuted() {
            ...
            ToolExecutionResult enriched = manager.executeToolCalls(mock(Prompt.class), mock(ChatResponse.class));
            ...
            assertThat(enriched.conversationHistory().get(2).getText()).contains("Do not call any tools again");
        }
    ...
    class AdvisorChainParity {
        ...
        void shouldPassDisabledRequestToChainWhenTerminalToolPresent() {
            ...
            ChatClientRequest request = requestWithHistory(List.of(
                    new UserMessage("news"),
                    toolResponse("call-1", "searchWeb", "snippets")));
