...
import com.ai.vision.infrastructure.VisionModelProperties;
...
class YoloNonMaxSuppressionTest {
    ...
    void should_suppress_overlapping_boxes() {
        var candidates = java.util.List.of(
                new com.ai.vision.domain.Detection("person", 0.9, 10, 10, 50, 50),
                new com.ai.vision.domain.Detection("person", 0.8, 12, 12, 48, 48),
                new com.ai.vision.domain.Detection("car", 0.7, 200, 200, 60, 40));
