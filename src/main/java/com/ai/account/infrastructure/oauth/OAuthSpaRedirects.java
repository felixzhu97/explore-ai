...
final class OAuthSpaRedirects {
    ...
    static String afterLogin(HttpServletRequest request, String configuredRedirectUrl, String loginValue) {
    ...
    static String withLoginParam(String redirectUrl, String loginValue) {
        ...
        if (base.startsWith("/")) {
            return UriComponentsBuilder.fromPath(base.contains("?") ? base.substring(0, base.indexOf('?')) : base)
