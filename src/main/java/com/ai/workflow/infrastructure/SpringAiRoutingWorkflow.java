  ...
  public RoutingResult route(String input, Map<String, String> routes) {
    ...
    if (selectedPrompt == null) {
      throw new IllegalArgumentException(
          "Selected route '" + selection + "' not found in routes map");
    }
  ...
  private RouteClassification classify(String input, Set<String> availableRoutes) {
    String selectorPrompt =
        """
                ...
                {
                    "reasoning": "Brief explanation of why this ticket should be routed to a
                specific team. Consider key terms, user intent, and urgency level.",
                    "selection": "The chosen team name"
                }

                Input: %s"""
            .formatted(availableRoutes, input);
    ...
    if (classification == null
        ...
        || classification.selection().isBlank()) {
