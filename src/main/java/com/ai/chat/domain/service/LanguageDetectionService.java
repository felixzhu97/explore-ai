...
/**
 * Lightweight language detection service using JDK standard library. Detects primary language based
 * on character distribution in input text.
 */
public class LanguageDetectionService {
   ...
   * @return language code: "zh" for Chinese, "ja" for Japanese, "en" for English, "default"
   *     otherwise
   */
  public String detect(String text) {
    ...
    boolean isPredominantlyJapanese =
        hasJapaneseContent && japaneseKanaCount > totalChars * JAPANESE_KANA_THRESHOLD;
    boolean isPredominantlyChinese =
        cjkCount > totalChars * CHINESE_CJK_THRESHOLD && !isPredominantlyJapanese;
