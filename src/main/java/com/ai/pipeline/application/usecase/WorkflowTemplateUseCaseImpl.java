...
public class WorkflowTemplateUseCaseImpl implements WorkflowTemplateUseCase {
    ...
    public SavedWorkflowTemplate create(
        ...
        SavedWorkflowTemplate template = SavedWorkflowTemplate.create(
                clientId,
                name,
                description,
                agentTypes,
    ...
    @Override
    public SavedWorkflowTemplate createFromTemplate(String clientId, String templateId, String language) {
        WorkflowTemplate template = WorkflowTemplateCatalog.findById(templateId, language)
                .orElseThrow(() -> new IllegalArgumentException("Unknown workflow template: " + templateId));
        return create(
                clientId,
    ...
    private SavedWorkflowTemplate findOwned(String clientId, String id) {
        return repository.findByIdAndClientId(WorkflowTemplateId.of(id), clientId)
