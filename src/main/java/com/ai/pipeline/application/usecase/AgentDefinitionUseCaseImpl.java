...
public class AgentDefinitionUseCaseImpl implements AgentDefinitionUseCase {
    ...
    public SavedAgentDefinition create(
        ...
        SavedAgentDefinition agent = SavedAgentDefinition.create(
                clientId, typeKey, name, description, systemPrompt, toolKeys);
    ...
    private SavedAgentDefinition findOwned(String clientId, String id) {
        return repository.findByIdAndClientId(SavedAgentId.of(id), clientId)
