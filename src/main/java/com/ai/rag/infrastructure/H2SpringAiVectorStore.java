...
import com.ai.rag.domain.VectorSimilarity;
 ...
 * Write path remains domain ETL ({@code EmbeddingDocumentWriter}); this adapter focuses on retrieval.
 */
@Component
public class H2SpringAiVectorStore implements VectorStore {
    ...
    public List<Document> similaritySearch(SearchRequest request) {
        ...
        List<DocumentChunk> chunks = docIds == null
