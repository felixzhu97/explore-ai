...
/**
 * Loads prompt text from {@code classpath:prompts/**}. Variable substitution uses Spring AI {@link
 * PromptTemplate} via {@link ClasspathPromptTemplate}; static fragments with JSON braces are loaded
