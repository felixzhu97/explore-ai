...
describe('AIInfraPanelComponent', () => {
  ...
  describe('onTabChange', () => {
    ...
    it('should work for all tab values', () => {
      const tabs: ('supervisor' | 'k8s' | 'monitoring' | 'model' | 'llmops' | 'aiops' | 'vectordb')[] = ['supervisor', 'k8s', 'monitoring', 'model', 'llmops', 'aiops', 'vectordb'];
      tabs.forEach((tab) => {
  ...
  describe('template rendering', () => {
    ...
    it('should render agent page', () => {
      fixture.detectChanges();
      const agentPage = fixture.nativeElement.querySelector('app-agent-component');
