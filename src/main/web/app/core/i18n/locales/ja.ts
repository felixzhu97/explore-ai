...
export const ja: Translations = {
  ...
  account: {
    ...
    loginFailed: 'サインインに失敗しました。ゲストのまま利用できます。',
  ...
  metricsPage: {
    ...
    overviewSubtitle: 'リクエスト量、レイテンシ、エラー、ドメイン健全性',
    domainTitle: '{domain} メトリクス',
    domainSubtitle: 'ドメイン別 KPI、チャート、呼び出し詳細',
    dayFilter: '· 日 {day}',
    modelFilter: '· モデル {model}',
    clearFilters: 'フィルターをクリア',
    range7d: '7日',
    range30d: '30日',
    loading: '読み込み中…',
    loadingOverview: 'メトリクスを読み込み中…',
    loadOverviewFailed: 'メトリクス概要の読み込みに失敗しました',
    loadDomainFailed: 'ドメインメトリクスの読み込みに失敗しました',
    unknownDomain: '不明なドメインです。',
    unknownDomainTitle: '不明なドメイン',
    backToOverview: '概要に戻る',
    openDomainHint: 'ドメインを開いて絞り込みチャートを表示 —',
    charts: {
      aiRequests: 'AI リクエスト',
      aiRequestsEmpty: 'この期間に AI リクエストはありません',
      requestsByDomain: 'ドメイン別リクエスト',
      requestsByDomainEmpty: 'ドメイン分布はまだありません',
      requestsOverTime: 'リクエスト推移',
      requestsOverTimeEmpty: 'この期間にリクエストはありません',
      callsByModel: 'モデル別呼び出し',
      callsByModelEmpty: 'モデル利用はまだありません',
      documentsByStatus: 'ステータス別ドキュメント',
      documentsByStatusEmpty: 'ドキュメントはまだありません',
    },
    kpi: {
      aiRequests: 'AI リクエスト',
      errorRate: 'エラー率',
    ...
    health: {
      heading: 'ドメイン健全性',
      empty: 'ドメイン健全性データがありません',
      chat: 'チャット',
      rag: 'RAG',
      agents: 'Agents',
      toolsMcp: 'ツール / MCP',
      vision: 'Vision',
      sessionsDetail: '{count} セッション',
      documentsDetail: '{count} ドキュメント',
      healthyDetail: '{healthy}/{total} 正常',
      toolsDetail: '{tools} ツール · {servers} サーバー',
      visionDetail: 'キャプション · 検出 · OCR',
    },
    drilldown: {
      recentHeading: '最近の呼び出し',
      filteredHeading: '絞り込み後の呼び出し',
      eventsCount: '{total} 件のイベント',
      empty: 'この条件の呼び出しイベントはありません',
      time: '時刻',
      operation: '操作',
      outcome: '結果',
      latency: 'レイテンシ',
  ...
  evalPage: {
    title: 'チャット評価',
    subtitle: 'LLM-as-Judge による品質と安全性の採点',
  ...
  mcpPage: {
    ...
    loading: 'ステータスを読み込み中…',
    tools: 'ツール',
    noTools: '登録済みツールはありません',
    tryWithTools: 'ツールで試す',
    placeholder: '質問を入力...',
    send: '送信',
    sending: '送信中...',
    errors: {
      healthFailed: 'MCP ヘルスの読み込みに失敗しました',
      clientStatusFailed: 'MCP クライアント状態の読み込みに失敗しました',
      toolsFailed: 'MCP ツールの読み込みに失敗しました',
      chatFailed: 'MCP チャットリクエストに失敗しました',
    },
  },
  pluginsPage: {
    title: 'プラグイン',
    subtitle: '組み込み／外部 MCP ツールをチャットに接続',
    loading: '読み込み中…',
    installed: 'インストール済み',
    installedEmpty: 'まだプラグインがありません。',
    featured: 'おすすめ',
    install: '追加',
    installTitle: 'プラグインを接続',
