...
export const zh: Translations = {
  ...
  agents: {
    ...
    deleteSession: '删除',
    emptySessions: '暂无会话',
    defaultTitle: '新 Agent',
    thinking: '思考中...',
    errorMessage: '出错了，请重试。',
    inputPlaceholder: '让 Agent 帮你调研或分析…',
    welcomeTitle: '与 Agent 协作',
    welcomeDescription: '带记忆、可再规划、工具过程可见——无需搭工作流图。',
    traceTitle: '过程',
    trace: {
      plan: '规划',
      replan: '再规划',
  ...
  pipelines: {
    ...
    pipeline: {
      ...
      emptyState: {
        title: '搭建多步工作流',
        description: '选择模版或添加 Agent，填写任务，运行工作流，再查看结果。',
      },
      hints: {
...
区分事实 / 推断 / 建议；禁止编造 URL。`,
  ...
  chat: {
    ...
    welcomeDescription: '随便问，或打开 Agent / 工作流继续深入',
    openPipelineWorkbench: '打开工作流',
