...
export const fr: Translations = {
  ...
  automationsPage: {
    ...
    frequencyCustom: 'Cron personnalisé',
    cronExpression: 'Expression cron (sec min heure jour mois jour-semaine)',
    brief: 'Brief de tâche',
    briefPlaceholder: 'Invite fixe envoyée au workflow',
    save: 'Enregistrer',
    saving: 'Enregistrement…',
    cancel: 'Annuler',
    edit: 'Modifier',
