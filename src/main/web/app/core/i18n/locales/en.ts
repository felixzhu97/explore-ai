...
export const en: Translations = {
  ...
  agents: {
    ...
    inputPlaceholder: 'Ask the agent to investigate...',
    welcomeTitle: 'Work with an Agent',
    welcomeDescription: 'Memory, planning, and tools — without building a workflow graph.',
    traceTitle: 'Trace',
    trace: {
      plan: 'Plan',
      replan: 'Replan',
  ...
  pipelines: {
    ...
    pipeline: {
      ...
      emptyState: {
        ...
        description: 'Pick a template or add agents, set the task, run the workflow, then review results.',
      },
      hints: {
...
Separate Fact vs Inference vs Recommendation. Do not invent URLs.`,
  ...
  chat: {
    ...
    welcomeDescription: 'Ask anything — or open Agent / Workflow for deeper work',
    openPipelineWorkbench: 'Open Workflow',
