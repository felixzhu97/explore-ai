...
@Component({
  ...
  template: `
    <header class="flex md:hidden items-center justify-between h-[52px] px-4 bg-white border-b border-black/8 sticky top-0 z-80">
      <button
        type="button"
        class="flex flex-col gap-[5px] p-2 bg-transparent border-none cursor-pointer"
      ...
      <div class="relative">
        <button
          type="button"
          class="flex items-center gap-1 px-[10px] py-[6px] rounded-md text-xs font-semibold text-text-secondary bg-transparent border-none cursor-pointer"
