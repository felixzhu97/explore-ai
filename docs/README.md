...
| [数字人服务](./digital-human.md) | 数字人服务架构、API 和部署指南 |
...
- **AI Agents 服务** (`services/ai_agents`) - 基于 LangGraph 的多智能体编排系统
...
| 功能 | 说明 | 技术方案 |
|------|------|----------|
| 实时对话 | WebSocket 双向通信 | FastAPI WebSocket |
| 语音合成 | 多引擎 TTS | Edge TTS / OpenAI TTS / gTTS |
| 表情动画 | 6 种基本表情 | Expression Controller |
| 口型同步 | Viseme 实时生成 | Viseme Generator |
| 手势动作 | 5 种常见手势 | Gesture Controller |
