...
import com.ai.modules.ai.web.dto.SessionInfo;
import com.ai.modules.rag.web.dto.DocumentSummaryDto;
...
class DtoFactoryMethodTest {
    ...
    class RagChatRequestNormalizationTests {
        ...
        void shouldKeepValidTemperatureUnchanged() {
            // Act
            RagChatRequest request = new RagChatRequest("Question", "session", 3, 0.9, null);
