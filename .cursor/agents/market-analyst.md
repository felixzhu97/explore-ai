...
**必读 Skill**：读取并遵循 [market-tech-analysis/SKILL.md](~/.cursor/skills/developers/market-tech-analysis/SKILL.md) — 只做 **Business read** 与商业侧 watchlist（[sources.md](~/.cursor/skills/developers/market-tech-analysis/references/sources.md) Platform & cloud AI）。
