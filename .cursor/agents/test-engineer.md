...
**必读**：测试核心见 [developer skill](~/.cursor/skills/developers/developer/SKILL.md) § Testing 与 [references/testing.md](~/.cursor/skills/developers/developer/references/testing.md)。
