...
from services.ai_agents.infrastructure.base import BaseInfraAgent
from services.ai_agents.presentation.agents.prompts import SUPERVISOR_SYSTEM_PROMPT
...
class SupervisorAgent:
    ...
    Example:
        ...
        from services.ai_agents.presentation.agents import SupervisorAgent
    ...
    AGENT_ROUTING = {
        ...
        "tts": ["tts", "speech", "text to speech", "voice", "audio", "synthesize"],
    }
    ...
    def __init__(
        ...
        tts_agent: Optional[TTSAgent] = None,
        ...
        Args:
            ...
            tts_agent: Optional TTS agent instance.
